	 ...
	 onsubmit="return validateCallback(this, dialogAjaxDone);">
		...
		<div class="pageFormContent" layoutH="54">
			<dl style="width: 100%;">
				<dt>发生日期：</dt>
				<dd style="width: 60%;">
					<input type="text" name="map[happendate]" size="25" class="required date" readonly="readonly"/>
			...
			<dl>
				<dt>金额：</dt>
				<dd>
					<input type="text" name="map[money]" class="required number" size="25" maxlength="9"/>
				</dd>
			</dl>
			<dl>
				<dt>备注：</dt>
				<dd>
					<textarea name="map[remark]" cols="27" rows="6" maxlength="512" class="required"></textarea>
				</dd>
			</dl>
		</div>
