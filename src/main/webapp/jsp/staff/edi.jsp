	 ...
	 onsubmit="return validateCallback(this, dialogAjaxDone);">
		...
		<div class="pageFormContent" layoutH="54">
			...
			<dl>
				<dt>联系电话：</dt>
				<dd>
					<input type="text" name="map[tel]" class="required" size="25" maxlength="32" alt="联系电话"
						value="${form.map.tel}"/>
				</dd>
			</dl>
			<dl>
				<dt>工资开户银行：</dt>
				<dd>
					<input type="text" name="map[bank]" size="25" maxlength="32" value="${form.map.bank}"/>
				</dd>
			</dl>
			<dl>
				<dt>工资银行账号：</dt>
				<dd>
					<input type="text" name="map[accountno]" size="25" maxlength="32" value="${form.map.accountno}"/>
				</dd>
			</dl>
			<dl>
				<dt>工资帐户名称：</dt>
				<dd>
					<input type="text" name="map[accountname]" size="25" maxlength="32" value="${form.map.accountname}"/>
				</dd>
			</dl>
			<dl style="width: 100%;">
				<dt>工资：</dt>
			...
			<dl>
				<dt>备注：</dt>
				<dd>
					<textarea name="map[remark]" cols="27" rows="6" maxlength="512">${form.map.remark}</textarea>
				</dd>
			</dl>
		</div>
